...
const FarmCard: React.FC<FarmCardProps> = ({ farm, displayApr, removed, cakePrice, account }) => {
  ...
  const lpLabel = farm.lpSymbol && farm.lpSymbol.toUpperCase().replace('TOCO', '')
  const earnLabel = farm.dual ? farm.dual.earnLabel : t('TOCO')
  ...
  const isPromotedFarm = farm.token.symbol === 'TOCO'
